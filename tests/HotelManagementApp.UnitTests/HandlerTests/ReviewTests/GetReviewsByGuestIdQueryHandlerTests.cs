...
{
    public class GetReviewsByGuestIdQueryHandlerTests
    {
        ...
        private readonly GetReviewsByGuestIdQueryHandler _handler;

        public GetReviewsByGuestIdQueryHandlerTests()
        {
            _handler = new GetReviewsByGuestIdQueryHandler(
        ...
        [Fact]
        public async Task ShouldReturnReviewsByGuest()
        {
            var hotel = new Hotel
            {
                Id = 1,
            ...
            _reviewRepositoryMock.Setup(r => r.GetReviewsByGuest("123", It.IsAny<CancellationToken>()))
            ...
            var query = new GetReviewsByGuestIdQuery { GuestId = "123" };
