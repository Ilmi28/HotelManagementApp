...
public class LoyaltyPointsController(IMediator mediator) : ControllerBase
{
    ...
    [HttpPost("exchange")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public async Task<IActionResult> ExchangePointsForReward([FromBody] ExchangePointsForRewardCommand command, CancellationToken cancellationToken)
    {
        await mediator.Send(command, cancellationToken);
        return Ok();
    }
    ...
    /// <summary>
    /// Returns all rewards acquired by a specific guest
    /// </summary>
    /// <response code="200">Returns list of acquired rewards</response>
    [HttpGet("guests/{guestId}/acquired-rewards")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public async Task<IActionResult> GetAcquiredRewardsByGuest(string guestId, CancellationToken cancellationToken)
    {
    ...
    /// <summary>
    /// Returns loyalty points balance for a specific guest
    /// </summary>
    /// <response code="200">Returns guest's loyalty points</response>
    [HttpGet("guests/{guestId}/points")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public async Task<IActionResult> GetLoyaltyPointsByGuest(string guestId, CancellationToken cancellationToken)
    {
    ...
    /// <summary>
    /// Returns loyalty points history for a specific guest
    /// </summary>
    /// <response code="200">Returns guest's loyalty points history</response>
    [HttpGet("guests/{guestId}/history")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    public async Task<IActionResult> GetLoyaltyPointsHistoryByGuest(string guestId, CancellationToken cancellationToken)
    {
    ...
    /// <summary>
    /// Returns loyalty points history for all guests
    /// </summary>
    ...
    /// <summary>
    /// Removes a specific loyalty reward
    /// </summary>
    ...
    /// <summary>
    /// Updates a specific loyalty reward
    /// </summary>
